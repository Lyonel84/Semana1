package com.nttdata.BC210.ManagementClientProduct.webclient.impl;

import com.nttdata.BC210.ManagementClientProduct.webclient.IServiceWC;
import com.nttdata.BC210.ManagementClientProduct.exception.ClientNotFoundException;
import com.nttdata.BC210.ManagementClientProduct.exception.ProductNotFoundException;
...
public class ServiceWCImpl implements IServiceWC {
    ...
    @Override
    public Mono<PasiveProduct> findPassiveProductById(String id) {
        return webClient.baseUrl(URL_API_PASIVEPRODUCT).build().get().uri("/api/product/passive/".concat(id))
                .retrieve()
