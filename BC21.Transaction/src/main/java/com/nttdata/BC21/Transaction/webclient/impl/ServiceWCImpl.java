package com.nttdata.BC21.Transaction.webclient.impl;

import com.nttdata.BC21.Transaction.exception.*;
import com.nttdata.BC21.Transaction.model.responseWC.*;
import com.nttdata.BC21.Transaction.exception.*;
import com.nttdata.BC21.Transaction.model.responseWC.*;
import com.nttdata.BC21.Transaction.webclient.IServiceWC;
...
public class ServiceWCImpl implements IServiceWC {
    ...
    public Mono<PasProPerCli> findPasProPerCliById(String id) {
        return webClient.baseUrl(URL_API_MANAGEMENT).build().get().uri("/api/passive/person/".concat(id))
                .retrieve()
    ...
    public Mono<PasProBusCli> findPasProBusCliById(String id) {
        return webClient.baseUrl(URL_API_MANAGEMENT).build().get().uri("/api/passive/business/".concat(id))
                .retrieve()
    ...
    public Mono<PasProPerCli> updatePasProPerCli(PasProPerCli pasProPerCli) {
        return webClient.baseUrl(URL_API_MANAGEMENT).build().put().uri("/api/passive/person/")
    ...
    public Mono<PasProBusCli> updatePasProBusCli(PasProBusCli pasProBusCli) {
        return webClient.baseUrl(URL_API_MANAGEMENT).build().put().uri("/api/passive/business/")
